SELECT reports.reported_at_ms, app_eui.name, dev_eui.name, reports.dc_balance, reports.fcnt, reports.port, device_names.name, reports.battery_voltage, points.lat, points.lng, points.alt, points.accuracy, points.fix, points.satellites
FROM (((((reports
